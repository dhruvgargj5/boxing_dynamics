...
def main(video_path: str, name: str, debug_logging: bool, scale_factor: float, model_fidelity):
    ...
    #                                                                                 landmarkers, 
    #                                                                                 save_video=True))
    # Stage 7️⃣: Fuse the video with arrows and boxing metrics into one output video
    ...
    # Stage 6️⃣: Fuse the input video and boxing metrics into one output video
